package com.test.carweather.view.indicator;
...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            canvas.drawLine((i == mCurrentPage) ? dx1: dx1 + mLineWidth/3, verticalOffset, (i == mCurrentPage) ? dx2 : dx2 - mLineWidth/3, verticalOffset, (i == mCurrentPage) ? mPaintSelected : mPaintUnselected);
        }
    }
