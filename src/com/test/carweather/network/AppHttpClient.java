...
import com.test.carweather.utils.FileUtil;
...
public class AppHttpClient {
    ...
    private Map<String, Object> serviceByType = new HashMap<String, Object>();
    ...
    private Cache cache() {
        final File baseDir = FileUtil.getExternalCacheDir(WeatherApplication.getContext());
    ...
    public static String getCookieHeader( ) {
        ...
        cookieHeader.append("customer_key").append('=').append(Constants.CUSTOMER_KEY);
        cookieHeader.append("; ");
        cookieHeader.append("access_token").append('=').append(Constants.ACCESS_TOKEN);
        return cookieHeader.toString();
      }

    public static String getActiveCookieHeader( ) {
        StringBuilder cookieHeader = new StringBuilder();
        cookieHeader.append("customer_key").append('=').append(Constants.CUSTOMER_KEY_ACTIVE);
        cookieHeader.append("; ");
        cookieHeader.append("access_token").append('=').append(Constants.ACCESS_TOKEN_ACTIVE);
        return cookieHeader.toString();
      }

    public static HashMap<String, String> getCommonHashMap( ) {
        String unixTime = String.valueOf(System.currentTimeMillis() / 1000L);
        String md5 = EncryptUtils.getMD5(Constants.ACCESS_TOKEN  + unixTime);

        HashMap<String, String> hashMap = new HashMap<String, String>();
        hashMap.put("request_time", unixTime);
        hashMap.put("check_code", md5);
        return hashMap;
    }
}
