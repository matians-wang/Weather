...
public class MultiItemTypeAdapter<T> extends BaseAdapter {
    ...
    protected boolean hasSelectionEffect;
...
//                viewHolder.getConvertView().setBackgroundResource(R.drawable.item_onplay);
//                //viewHolder.setVisible(R.id.speaking_news, true);
//                viewHolder.setVisible(R.id.wave, true);
//            }else {
//                viewHolder.getConvertView().setBackground(null);
//                //viewHolder.setVisible(R.id.speaking_news, false);
//                viewHolder.setVisible(R.id.wave, false);
//            }
//        }
